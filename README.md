...
Panel plugin for [DTCD](https://github.com/ISGNeuroTeam/DTCD) application designed to displaying the graph structure received from the LiveDashPanel.
...
- [DTCD](https://github.com/ISGNeuroTeam/DTCD) v0.10.0
- `make` utility
